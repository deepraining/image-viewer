      ...
      <div className={styles.item} key={item.id}>
        <div className={styles.inner}>
          ...
          <div className={styles.actions}>
            <button type="button" className={`clean ${styles.action} fa fa-ban fl-right`} title="delete"
                    onClick={this.onClickDelete} data-id={item.id}/>
            <button type="button" className={`clean ${styles.action} fa fa-sync-alt fl-right`} title="refresh"/>
          </div>
        </div>
      </div>
    ));
    ...
    return (
      <div className={styles.container}>
        <div className={styles.topBar}>
          ...
          <button type="button" className={`clean ${styles.action} fa fa-ban fl-right`} title="delete all albums"
                  onClick={this.deleteAllAlbums}/>
          <button type="button" className={`clean ${styles.action} fa fa-sync-alt fl-right`}
